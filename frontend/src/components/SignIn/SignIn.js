...
class SignIn extends Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://smart-brain-backend-zha7.onrender.com/api/signin', {
            method: 'post',
                ...
                <main className='w-75 pa4 black-80'>
                    <div className="measure">
                        ...
                        <div className="lh-copy mt1 center">
                            <Link to="/" style={{textDecoration: 'none'}}><p onClick={() => this.props.onRouteChange('register')} className="f5 link dim black db pointer">Register</p></Link>
                        </div>
                    </div>
